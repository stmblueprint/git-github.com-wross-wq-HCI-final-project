...
;
    ...
    .fa-solid, .fa-cart-shopping, .fa-user-astronaut{
        height: 1px;
        opacity: 0.75;
    }
...
<span class="center header-grid">
    <div class="logo-container">
       <a href="index.php"><div class="logo center" style='font-size: 10px;'>Retro Gaming</div></a>
       <br/>
       <span class="username-display">Hello,&nbsp;<?php echo $_SESSION['username'];?></span>
    </div>
...
<script>
    document.getElementById('sign-out-button').addEventListener('click', function(){
        ...
        window.top.location = 'registration.php';
    });
</script>
